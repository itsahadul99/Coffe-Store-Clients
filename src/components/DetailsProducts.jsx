                ...
                <div className="w-full md:w-1/2 mx-auto bg-[#F4F3F0]">
                    <div className="flex flex-col lg:flex-row items-center justify-center sm:gap-5 lg:gap-10 p-5 md:p-10">
                        ...
                        <div>
                            ...
                            <p className="text-[#1B1A1A] font-semibold text-sm lg:text-lg">Category: <span className="text-[#5C5B5B] text-sm font-normal">test</span></p>
                            <p className="text-[#1B1A1A] font-semibold text-sm lg:text-lg">Details: <span className="text-[#5C5B5B] text-sm font-normal">test</span></p>
                        </div>
                    </div>
                </div>
            </div>
