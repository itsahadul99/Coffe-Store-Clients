            ...
            <div className="hero min-h-[500px]" style={{ backgroundImage: `url(${footerBg})` }}>
                ...
                <div className="flex flex-col lg:flex-row justify-center lg:gap-20 items-center">
                    <div className="flex-1">
                        ...
                        <h1 className="mb-5 text-2xl lg:text-5xl font-bold text-[#331A15]">Espresso Emporium</h1>
                        ...
                        <h1 className="mb-5 text-xl lg:text-4xl font-bold text-[#331A15]">Get in Touch</h1>
                    ...
                    <div className='flex-1'>
                        <h1 className="mb-5 text-2xl lg:text-5xl font-bold text-[#331A15]">Connect with Us</h1>
                        <div className='w-full'>
                            <div className='flex flex-col w-full space-y-5'>
                                ...
                                <button className='px-3 md:px-5 py-2 md:py-3 rounded-full text-[#331A15] text-sm md:text-xl border-2 border-[#331A15]'>Send Message</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className='h-12' style={{ backgroundImage: `url(${footerend})` }}>
                    <h1 className='text-center pt-4 text-sm md:text-xl'>Copyright Espresso Emporium ! All Rights Reserved</h1>
                </div>
        </footer>
    );
};
